...
//      TODO (4) Remove the call to setContentVie
...
//      TODO (7) Display the weather icon using mDetailBinding
        ...
        mDetailBinding.primaryInfo.weatherIcon.setImageResource(weatherId);
...
//      TODO (8) Use mDetailBinding to display the date
         ...
         ***********************/
        /* Read weather condition ID from the cursor (ID provided by Open Weather Map) */
        int weatherId1 = data.getInt(INDEX_WEATHER_CONDITION_ID);
        /* Use the weatherId to obtain the proper description */
        String description = SunshineWeatherUtils.getStringForWeatherCondition(this, weatherId1);
...
//      TODO (17) Create the content description for the high temperature for a11y
         String s=getString(R.string.a11y_high_temp,highString);
