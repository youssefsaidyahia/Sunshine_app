...
public class MainActivity extends AppCompatActivity implements ForecastAdapterOnClickHandler, android.support.v4.app.LoaderManager.LoaderCallbacks<Object> {

    private static final String TAG = MainActivity.class.getSimpleName();
      static private int FORECAST_LOADER_ID=22;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LoaderManager.LoaderCallbacks<String[]> l= (LoaderManager.LoaderCallbacks<String[]>) MainActivity.this;
    ...
    public Loader<Object> onCreateLoader(int id, final Bundle args) {
        return new Loader<Object>(this) {
            ...
            public String[] loadInBackground() {
                String ll=SunshinePreferences
                        .getPreferredWeatherLocation(MainActivity.this);

                URL weatherRequestUrl = NetworkUtils.buildUrl(ll);
                    try {
    ...
    @Override
    public void onLoadFinished(loader, String data) {
