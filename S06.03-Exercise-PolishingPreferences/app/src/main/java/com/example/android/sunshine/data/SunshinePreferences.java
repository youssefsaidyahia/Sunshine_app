...
public class SunshinePreferences {
    ...
    public static boolean isMetric(Context context) {
        ...
        String s=context.getString(R.string.pref_units_key);
        String s1=context.getString(R.string.pref_units_metric);
        String s2=context.getString(R.string.pref_units_metric);
        String p1=prefs.getString(s,s1);
        /** This will be implemented in a future lesson **/
        if(s2.equals(p1)){
            return true;
        }
