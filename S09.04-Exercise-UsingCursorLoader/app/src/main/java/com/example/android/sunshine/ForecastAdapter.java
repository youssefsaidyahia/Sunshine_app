...
//      TODO (7) Generate a weather summary with the date, description, high and low
        ...
        String dataString= SunshineDateUtils.getFriendlyDateString(mContext ,dateInMillis , false);
        ...
        String s = SunshineWeatherUtils.formatHighLows(mContext ,highInCelsius ,LowInCelsius);
//      TODO (8) Display the summary that you created above
        String weatherSummary = dataString + " - " + description + " - " + s ;
